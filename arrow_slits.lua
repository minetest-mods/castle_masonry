...
castle_masonry.register_arrowslit = function(material)
	...
	minetest.register_node(mod_name..":arrowslit_"..material.name.."_cross", {
		...
		node_box = {
			type = "fixed",
			fixed = {
				{-0.5, 0.0625, 0.5, -0.0625, 0.375, 0.3125},
				{0.0625, 0.0625, 0.5, 0.5, 0.375, 0.3125},
				{-0.5, 0.375, 0.5, 0.5, 0.5, 0.3125},
				{-0.5, -0.5, 0.5, 0.5, -0.375, 0.3125},
				{0.0625, -0.375, 0.5, 0.5, -0.0625, 0.3125},
				{-0.5, -0.375, 0.5, -0.0625, -0.0625, 0.3125},
				{-0.5, 0.0625, 0.5, -0.1875, -0.0625, 0.3125},
				{0.1875, 0.0625, 0.5, 0.5, -0.0625, 0.3125},
				{0.25, -0.5, 0.3125, 0.5, 0.5, 0.125},
				{-0.5, -0.5, 0.3125, -0.25, 0.5, 0.125},
			},
		},
